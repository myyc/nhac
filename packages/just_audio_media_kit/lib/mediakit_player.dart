...
class MediaKitPlayer extends AudioPlayerPlatform {
  ...
  MediaKitPlayer(super.id) {
    ...
    // Disable youtube-dl/yt-dlp hook - we're playing direct audio streams, not YouTube URLs
    // This prevents mpv from trying to invoke youtube-dl on every URL and failing
    setProperty(_player, 'ytdl', 'no');

    // Disable disk cache - can cause "Failed to create file cache" errors in sandboxed environments
